...
class TestContentPathStrategy(unittest.TestCase):
    ...
    def test_search_with_regex_match(self):
        ...
        memories = [
            {
                "id": "mem1",
                "content": {"title": "Meeting 2023-01-15", "status": "completed"},
                "metadata": {},
            },
            {
                "id": "mem2",
                "content": {"title": "Meeting 2023-02-20", "status": "pending"},
                "metadata": {},
            },
            {
                "id": "mem3",
                "content": {"title": "Call 2023-03-10", "status": "completed"},
                "metadata": {},
            },
        ]
    ...
    def test_search_with_exists_check(self):
        ...
        memories = [
            ...
            {
                "id": "mem2",
                "content": {"title": "Report", "tags": ["important"]},
                "metadata": {},
            },
        ]
    ...
    def test_invalid_path_format(self):
        ...
        with self.assertRaises(ValueError):
            self.strategy.search(
                query={}, agent_id="agent-1", tier="stm"  # Missing path
            )
        ...
        memories = [
            {
                ...
                "content": "Content A",
                "metadata": {
                    "source": {"type": "email", "address": "sender@example.com"}
                },
            },
            {
                "id": "mem2",
                "content": "Content B",
                "metadata": {"source": {"type": "chat", "platform": "Slack"}},
            },
        ]
