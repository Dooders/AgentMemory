...
class TestAttributeSearchStrategy(unittest.TestCase):
    ...
    def test_search_dict_query(self):
        ...
        # Perform search with dictionary query
        results = self.strategy.search(
            query={"metadata": {"type": "meeting"}},
            agent_id="agent-1",
            tier="im",
            limit=5
        )
    ...
    def test_search_with_case_sensitive(self):
        ...
        case_sensitive_memories[0]["content"] = "MEETING with John about the project"
        
        self.mock_stm_store.get_all_for_agent.return_value = case_sensitive_memories
    ...
    def test_search_with_custom_fields(self):
        ...
        results = self.strategy.search(
            ...
            metadata_fields=["importance"],  # Only search in importance field
            limit=5
        )
