...
class TestNarrativeSequenceStrategy(unittest.TestCase):
    ...
    def test_search_with_time_window(self):
        ...
        memories = [
            {
                ...
                "metadata": {"timestamp": (reference_time - timedelta(minutes=30)).isoformat()}
            },
            {
                "id": "mem2",
                "content": "Just before reference",
                "metadata": {"timestamp": (reference_time - timedelta(minutes=4)).isoformat()}
            },
            {
                "id": "mem3",  # Reference memory
                "content": "Reference memory",
            ...
            },
            {
                ...
                "metadata": {"timestamp": (reference_time + timedelta(minutes=5)).isoformat()}
            },
            {
                "id": "mem5",
                "content": "Far after reference",
                "metadata": {"timestamp": (reference_time + timedelta(minutes=25)).isoformat()}
            }
        ]
        ...
        self.assertEqual(results[0]["id"], "mem2")  # Just before reference (within window)
        self.assertEqual(results[1]["id"], "mem3")  # Reference memory
        self.assertEqual(results[2]["id"], "mem4")  # Just after reference (within window)
