...
class TestImportanceStrategy(unittest.TestCase):
    ...
    def test_search_min_importance(self):
        ...
        memories = [
            {"id": "mem1", "content": "Important meeting", "metadata": {"importance": 8}},
    ...
    def test_search_importance_range(self):
        ...
        memories = [
            ...
            {"id": "mem2", "content": "Regular task", "metadata": {"importance": 3}},
            {"id": "mem3", "content": "Critical alert", "metadata": {"importance": 9}},
            {"id": "mem4", "content": "Semi-important report", "metadata": {"importance": 6}},
    ...
    def test_search_with_metadata_filter(self):
        ...
        # Set up mock memory data
        memories = [
            {"id": "mem1", "content": "Important meeting", "metadata": {"importance": 8, "type": "meeting"}},
            {"id": "mem2", "content": "Regular task", "metadata": {"importance": 3, "type": "task"}},
            {"id": "mem3", "content": "Critical alert", "metadata": {"importance": 9, "type": "alert"}},
            {"id": "mem4", "content": "Important task", "metadata": {"importance": 7, "type": "task"}}
        ]
