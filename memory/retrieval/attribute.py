...
class AttributeRetrieval:
    ...
    def retrieve_by_memory_type(
        self, memory_type: str, limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
    ...
    def retrieve_by_importance(
        self, min_importance: float = 0.7, limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
    ...
    def retrieve_by_metadata(
        self, metadata_filters: Dict[str, Any], limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
    ...
    def retrieve_by_content_value(
        self, path: str, value: Any, limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
    ...
    def retrieve_by_content_pattern(
        self, path: str, pattern: str, limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
    ...
    def retrieve_by_tag(
        self, tag: str, limit: int = 10, tier: str = "stm"
    ) -> List[Dict[str, Any]]:
            ...
            for condition in conditions:
                if condition.get("type") == "metadata":
                    ...
                    content_actual = self._get_value_at_path(
                        memory.get("contents", {}), content_path
                    )
                    ...
                    try:
                        ...
                        pattern_actual = self._get_value_at_path(
                            memory.get("contents", {}), pattern_path
                        )
    ...
    def _matches_metadata_filters(
        self, memory: Dict[str, Any], filters: Dict[str, Any]
    ) -> bool:
