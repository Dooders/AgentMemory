...
class BaseAgent:
    ...
    def act(self, observation=None, **kwargs):
        ...
        return ActionResult(action_type="noop", params={}, reward=0.0)
...
class ActionResult:
    """Simple container for action results."""

    def __init__(self, action_type: str, params: Dict[str, Any], reward: float = 0.0):
    ...
    def act_with_memory(self, *args, **kwargs):
        ...
        try:
            ...
            self.memory_system.store_agent_action(
                self.agent_id, action_data, step_number, priority=importance
            )
